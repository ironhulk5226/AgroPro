    ...
    <div className="layout-container flex h-full grow flex-col">
      ...
      <div className="flex flex-1 justify-center items-center py-5">
        <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1 items-center">
          <h2 className="text-[#131613] tracking-light text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">Create an Account</h2>

          {/* Name Field */}
          <div className="flex max-w-[480px] w-full flex-wrap items-center gap-4 px-4 py-3">
            <label className="flex flex-col min-w-40 flex-1">
              <p className="text-[#131613] text-base font-medium leading-normal pb-2">Name</p>
              <input
          ...
          <div className="flex max-w-[480px] w-full flex-wrap items-center gap-4 px-4 py-3">
           ...
           {/* Password Field with Eye Button */}
            <div className="flex max-w-[480px] w-full flex-wrap items-center gap-4 px-4 py-3">
              <label className="flex flex-col min-w-40 flex-1">
                <p className="text-[#131613] text-base font-medium leading-normal pb-2">
                  Password
                </p>
