    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      <main className="px-40 flex flex-1 justify-center py-5 bg-white dark:bg-gray-900 transition-colors duration-200">
        <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
          ...
          <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 mb-6 transition-colors duration-200">
            <h2 className="text-[#111811] dark:text-white text-[22px] font-bold pb-3 pt-1 transition-colors duration-200 flex items-center gap-3">
              <div className="w-1 h-6 bg-green-600 rounded-full"></div>
              Established in 2023 | Based in Karad, Satara
            </h2>
            <p className="text-[#111811] dark:text-gray-300 text-base pb-3 pt-1 leading-relaxed transition-colors duration-200">
          ...
          <div className="mb-6">
            <h2 className="text-[#111811] dark:text-white text-[22px] font-bold px-4 pb-3 pt-5 transition-colors duration-200 flex items-center gap-3">
              <div className="w-1 h-6 bg-green-600 rounded-full"></div>
              Specialization
            </h2>
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-green-100 dark:border-gray-700 transition-colors duration-200">
              <p className="text-[#111811] dark:text-gray-300 text-base leading-relaxed transition-colors duration-200">
          ...
          <div className="mb-6 ">
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 shadow-md border border-green-100 dark:border-gray-700 transition-colors duration-200">
              <div className="mb-6">
                <div className="inline-flex items-center gap-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-lg px-3 py-1 mb-3 text-sm font-semibold transition-colors duration-200">
                  Flagship Product
                </div>
                <h3 className="text-[#111811] dark:text-white text-2xl font-bold mb-3 transition-colors duration-200">Sapling Transplanter VAJRA</h3>
                <p className="text-[#111811] dark:text-gray-300 leading-relaxed transition-colors duration-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-[#dbe6db] dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <div className="p-2 text-green-700 dark:text-green-500 mb-3 transition-colors duration-200">
                    <HiOutlineLightningBolt className="w-6 h-6" />
                  </div>
                  <h4 className="text-[#111811] dark:text-white font-bold text-sm mb-1 transition-colors duration-200">Revolutionary Speed</h4>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-[#dbe6db] dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <h4 className="text-[#111811] dark:text-white font-bold text-sm mb-1 transition-colors duration-200">Enhanced Accuracy</h4>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-[#dbe6db] dark:border-gray-700 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  ...
                  <h4 className="text-[#111811] dark:text-white font-bold text-sm mb-1 transition-colors duration-200">Labor Reduction</h4>
          ...
          <div className="mb-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-green-100 dark:border-gray-700 transition-colors duration-200">
              ...
              <br />
              <p className="text-green-600 dark:text-green-400 font-semibold text-base transition-colors duration-200">
          ...
          <div className="mb-8">
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 shadow-md border border-green-100 dark:border-gray-700 transition-colors duration-200">
              <p className="text-[#111811] dark:text-gray-300 text-base leading-relaxed mb-4 transition-colors duration-200">
              ...
              <ul className="text-[#111811] dark:text-gray-300 text-base space-y-2 transition-colors duration-200">
          ...
          <div className="text-center py-8">
            <h2 className="text-[#111811] dark:text-white text-xl font-bold mb-6 transition-colors duration-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center min-w-[200px] cursor-pointer overflow-hidden rounded-xl h-12 px-6 bg-[#11d411] dark:bg-green-600 text-white text-base font-bold leading-normal tracking-[0.015em] transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1 hover:bg-green-600 dark:hover:bg-green-700"
                target="_blank"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center min-w-[200px] cursor-pointer overflow-hidden rounded-xl h-12 px-6 bg-transparent border-2 border-[#11d411] dark:border-green-600 text-[#11d411] dark:text-green-600 text-base font-bold leading-normal tracking-[0.015em] transition-all duration-300 ease-in-out hover:shadow-lg hover:-translate-y-1 hover:bg-[#11d411] hover:text-white dark:hover:bg-green-600 dark:hover:text-white"
                target="_blank"
              >
