...
const Hero = () => {
  ...
  const achievements = [
    {
      ...
      description:
        "Team INDRA has secured ALL INDIA RANK 3 for overall season held in 2024.",
    ...
    },
    {
      ...
      description:
        "Team INDRA has secured ALL INDIA RANK 1 for design Presentation held in December 2023.",
    ...
    },
    {
      ...
      description:
        "Team INDRA has secured ALL INDIA RANK 1 in category of Best Design.",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      testimonial:
        "AgroPro has completely transformed the way I approach farming. The crop recommendation system helped me identify the best crops for my land, and the results have been amazing. My yield has doubled this season!",
    },
    {
      id: 2,
      name: "Maruti Patil",
      ...
      rating: 4,
      testimonial:
        "As a small farmer, I always struggled to make decisions about fertilizers. The fertilizer recommendation system is a game-changer. It provided me with accurate suggestions, and I saw a noticeable improvement in my crop quality.",
    },
    {
      id: 3,
      name: "Ramesh Patil",
      ...
      rating: 5,
      testimonial:
        "The plant disease classifier saved my tomato crop! I uploaded a photo, and within seconds, I knew exactly what disease it was and how to treat it. AgroPro is a must-have for every farmer.",
    },
    {
      id: 4,
      name: "Vithal Mangore",
      ...
      rating: 4,
      testimonial:
        "The Agro-Chat feature is so helpful. I can ask questions in my local language, and I always get quick and reliable advice. It feels like having an expert by my side all the time.",
    },
    {
      id: 5,
      name: "Nivas Chopade",
      ...
      rating: 5,
      testimonial:
        "Farming used to feel overwhelming, but with AgroPro, I now have all the information I need at my fingertips. The multilingual support makes it so easy to use, even for someone like me who isn't fluent in English.",
    },
    {
      id: 6,
      name: "Sumit Patil",
      ...
      rating: 5,
      testimonial:
        "Thanks to AgroPro, I've adopted smarter, more sustainable farming practices. The insights provided are not only improving my yield but also helping me conserve resources like water and fertilizers.",
    },
  ];
  ...
  const prevFeaturePage = () => {
    ...
    setIsFeatureTransitioning(true);
    setTimeout(() => {
      setCurrentFeaturePage(
        (prev) => (prev - 1 + totalFeaturePages) % totalFeaturePages,
      );
      setTimeout(() => setIsFeatureTransitioning(false), 100);
    }, 150);
  };
          ...
          <div className="mb-16 px-4 py-10 @container">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
                Hear what our farmers have to say about their experience with
                AgroPro
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div
                className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 min-h-[400px] transition-all duration-300 ease-in-out transform ${
                  isTransitioning
                    ? "opacity-0 scale-95"
                    : "opacity-100 scale-100"
                }`}
              >
                {currentTestimonials.map((testimonial, index) => (
                  <div
                    ...
                    style={{
                      boxShadow:
                        "0 10px 25px -5px rgba(20, 183, 20, 0.3), 0 10px 10px -5px rgba(20, 183, 20, 0.04)",
                    }}
                  >
                    {/* Quote Icon */}
                    ...
                    <div className="flex items-center mb-4 mt-2">
                      <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-green-200 dark:border-green-700 mr-4 flex-shrink-0">
                        ...
                        />
                        <div
                          className="w-full h-full bg-green-100 dark:bg-green-900 flex items-center justify-center"
                          style={{ display: "none" }}
                        >
