          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            <div className="flex flex-wrap justify-between gap-3 p-4">
              <div className="flex min-w-72 flex-col gap-3">
                <p className="text-[#151811] tracking-light text-[32px] font-bold leading-tight">
                  Field Data Wizard
                </p>
                <p className="text-[#788863] text-sm font-normal leading-normal">
            ...
            {/* Tabs */}
            <div className="pb-3">
              <div className="flex border-b border-[#e1e5dc] px-4 gap-8">
                <a onClick={() => setCurrentStep(Page.Step1)}
                  className={` flex flex-col items-center justify-center pb-[13px] pt-4
                  ${currentStep === Page.Step1 ? "border-b-[3px] border-b-[#151811] text-[#151811]" : "text-[#788863]"}`}
                >
                  <p className="text-sm font-bold hover: cursor-pointer hover:text-[#151811]">Crop</p>
                </a>
                <a onClick={() => setCurrentStep(Page.Step2)}
                  className={` flex flex-col items-center justify-center pb-[13px] pt-4
                  ${currentStep === Page.Step2 ? "border-b-[3px] border-b-[#151811] text-[#151811]" : "text-[#788863]"}`}
                >
                  <p className="hover: cursor-pointer text-sm font-bold hover:text-[#151811]">Soil</p>
                </a>
                <a onClick={() => setCurrentStep(Page.Step3)}
                  className={` flex flex-col items-center justify-center pb-[13px] pt-4
                  ${currentStep === Page.Step3 ? "border-b-[3px] border-b-[#151811] text-[#151811]" : "text-[#788863]"}`}
                >
                  <p className="hover: cursor-pointer text-sm font-bold hover:text-[#151811]">Irrigation</p>
                </a>
              </div>
            </div>
            ...
            <div className="flex justify-stretch">
              <div className="flex flex-1 gap-3 flex-wrap px-4 py-3 justify-between">
                {currentStep > 1 && (
                  <button
                    onClick={handleBack}
                    className="hover:bg-[#91e619b9] hover: cursor-pointer flex min-w-[84px] items-center justify-center rounded-xl h-10 px-4 bg-[#f3f4f0] font-bold"
                  >
                    Back
                  </button>
                )}
                <button
                  onClick={handleNext}
                  className="hover:bg-[#91e619b9] hover: cursor-pointer flex min-w-[84px] items-center justify-center rounded-xl h-10 px-4 bg-[#91e619] font-bold"
                >
                  {submitButtonText}
                </button>
              </div>
